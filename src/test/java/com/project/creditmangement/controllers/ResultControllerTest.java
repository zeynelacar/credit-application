...
public class ResultControllerTest {
    ...
    void makeApplication() throws Exception{
        ...
        Mockito.doReturn(expectedResult).when(resultService).makeApplication(applicant);
    ...
    List<Result> getTestResults() {
        ...
        results.add(new Result(1,"11111111111","Denied",null));
        results.add(new Result(2,"22222222222","Approved",10000));
        results.add(new Result(3,"33333333333","Approved",50000));
        return results;
